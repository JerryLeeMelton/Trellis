...
export default function TrellisContent({ tags }: ProjectContentProps) {
  return (
    <div className="project-page-content">
      ...
      <p>
        I&apos;m always very particular about my personal portfolio website, so
        I wanted to be sure to build it from scratch. There&apos;s a lot of high
        quality templates out there but I always wind up having to make more
        manual adjustments than I would like and the way that they&apos;re
        structured is never really to my liking. I wanted the site to be
        something I was proud to show off, so building it from the ground up
        seemed like a no-brainer in this situation.
      </p>
      ...
      <p>
        ...
        unnecessary bloat. I wound up deciding on Next.js using Typescript.
        I&apos;ve been really enjoying the more self-contained nature of Next.js
        and just the overall structure of its projects, so I wanted an excuse to
        work more with it having come from working heavily with vanilla React at
        my previous job.
      </p>
